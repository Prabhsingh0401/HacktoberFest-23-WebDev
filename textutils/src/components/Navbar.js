...
Navbar.propTypes = {
  ...
  // isRequired lgane se undefined prop error aayega agr koi cheez na paas ho excluding defaultprop
  title: PropTypes.string.isRequired,
  AboutText: PropTypes.string.isRequired
}

// Used when no props are being passed
Navbar.defaultProps = {
